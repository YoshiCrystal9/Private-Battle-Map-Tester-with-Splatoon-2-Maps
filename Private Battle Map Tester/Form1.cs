    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            NameWrapper[] stages = {
                ...
                new NameWrapper("The Reef v1", 16),
                new NameWrapper("Musselforge Fitness", 17),
                new NameWrapper("Starfish Mainstage", 18),
                new NameWrapper("Sturgeon Shipyard", 19),
                new NameWrapper("Inkblot Art Academy", 20),
                new NameWrapper("Humpback Pump Track", 21),
                new NameWrapper("Manta Maria", 22),
                new NameWrapper("Placeholder", 23),
                new NameWrapper("Placeholder", 24),
                new NameWrapper("Wahoo World", 25),
                new NameWrapper("Placeholder", 26),
                new NameWrapper("Goby Arena", 27),
                new NameWrapper("Snapper Canal", 28),
                new NameWrapper("MakoMart", 29),
                new NameWrapper("Placeholder", 39),
                new NameWrapper("Windmill House on the Pearlie", 51),
                new NameWrapper("Wayslide Cool", 52),
                new NameWrapper("The Secret of S.P.L.A.T.", 53),
                new NameWrapper("Goosponge", 54),
                new NameWrapper("Cannon Fire Pearl", 56),
                new NameWrapper("Zone of Glass", 57),
                new NameWrapper("Fancy Spew", 58),
                new NameWrapper("Grapplink Girl", 59),
                new NameWrapper("Zappy Longshocking", 60),
                new NameWrapper("The Bunker Games", 61),
                new NameWrapper("A Swiftly Tilting Balance", 62),
                new NameWrapper("The Splat in our Zones", 70),
                new NameWrapper("The Ink is Spreading", 71),
                new NameWrapper("Bridge to Tentaswitchia", 72),
                new NameWrapper("The Chronicles of Rolonium", 73),
                new NameWrapper("Furler in the Ashes", 74),
                new NameWrapper("MC.Princess Diaries", 75),
